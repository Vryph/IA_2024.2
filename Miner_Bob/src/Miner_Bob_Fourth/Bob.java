...
public class Bob extends Entity {
	...
	private boolean billyWorkState = true;
	...
	public Bob() {
		 ...
		 stateMachine.SetCurrentState(EntrarNaMinaECavarPorPepitas.getInstance());
	...
	public boolean didBillyWork() {
		return billyWorkState;
	}
	
	public void setBillyWork(boolean state) {
		billyWorkState = state;
	}
	...
	public void Banheiro() {
		System.out.println("Bob: Estou no Banheiro! -----------------------------------------------------------------------");
	}
