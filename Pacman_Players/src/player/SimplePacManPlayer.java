...
public class SimplePacManPlayer implements PacManPlayer {
  ...
  public Move chooseMove(Game game) {
    ...
    //Utiliza um Iterator para percorrer a lista de movimentos poss�veis e v�lidos:  - ISSO É UMA BUSCA EM LARGURA COM PROFUNDIDADE 1
  ...
  public double evaluateState(State s, State next) {
    ...
    score -= getMinDistance(pacManLocation, s.getDotLocations()); // being far from nearest dot is bad
