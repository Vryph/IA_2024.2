...
public class Pinky extends GhostPlayer {
	private StateMachine<Pinky> stateMachine;
	private Game game;
	private int index;
	...
	public Pinky(){
		stateMachine = new StateMachine<Pinky>(this);
		stateMachine.SetCurrentState(PinkyScatterState.getInstance());
	}
	
	
	public StateMachine<Pinky> getStateMachine(){
		return stateMachine;
	}
