...
public class Clyde extends GhostPlayer {
	private StateMachine<Clyde> stateMachine;
	private Game game;
	private int index;
	...
	public Clyde(){
		stateMachine = new StateMachine<Clyde>(this);
		stateMachine.SetCurrentState(ClydeScatterState.getInstance());
	}
	
	
	public StateMachine<Clyde> getStateMachine(){
		return stateMachine;
	}
