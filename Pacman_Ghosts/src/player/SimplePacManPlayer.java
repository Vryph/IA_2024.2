...
public class SimplePacManPlayer implements PacManPlayer {
  ...
  public Move chooseMove(Game game) {
	//Obtem o estado atual do jogo:  
	  GameState s = game.getCurrentGameState();
    
    //Obtem a lista de movimentos poss�veis e v�lidos:
    ...
    //Utiliza um Iterator para percorrer a lista de movimentos poss�veis e v�lidos:
    for (Move m : legalMoves) {
      
      //Obt�m uma lista de estados considerando que o pacman siga por um
      //determinado movimento at� encontrar uma nova interse��o. 
      List<GameState> stateList = Game.getProjectedStates(s, m); 
      
      //Obt�m o �ltimo estado da lista do caminho projetado:
      GameState last = stateList.get(stateList.size() - 1);
      
      //Obt�m uma avalia��o heur�stica do �ltimo estado da lista do caminho projetado:
  ...
  public double evaluateState(GameState s, GameState next) {
