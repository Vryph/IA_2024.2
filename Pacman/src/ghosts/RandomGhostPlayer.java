...
public class RandomGhostPlayer extends GhostPlayer {
  ...
  public Move chooseMove(Game game, int ghostIndex) {
		List<Pair<Move, Double>> distribution = getMoveDistribution(game, game.getCurrentGameState(), ghostIndex);
  ...
  public List<Pair<Move, Double>> getMoveDistribution(Game game, GameState state, int ghostIndex) {
