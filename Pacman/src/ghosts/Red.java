...
public class Red extends GhostPlayer {
	private StateMachine<Red> stateMachine;
	private Game game;
	private int index;
	...
	public Red(){
		stateMachine = new StateMachine<Red>(this);
		stateMachine.SetCurrentState(RedRunState.getInstance());
		stateMachine.SetGlobalState(RedGlobalState.getInstance());
	}
